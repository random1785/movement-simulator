execute at @e[type=armor_stand,tag=centre,scores={random=0}] run tp @a ~-625 200 ~-1950 0 0
execute at @e[type=armor_stand,tag=centre,scores={random=1}] run tp @a ~-500 200 ~-1950 0 0
execute at @e[type=armor_stand,tag=centre,scores={random=2}] run tp @a ~-375 200 ~-1950 0 0
execute at @e[type=armor_stand,tag=centre,scores={random=3}] run tp @a ~-250 200 ~-1950 0 0
execute at @e[type=armor_stand,tag=centre,scores={random=4}] run tp @a ~-125 200 ~-1950 0 0
execute at @e[type=armor_stand,tag=centre,scores={random=5}] run tp @a ~ 200 ~-1950 0 0
execute at @e[type=armor_stand,tag=centre,scores={random=6}] run tp @a ~125 200 ~-1950 0 0
execute at @e[type=armor_stand,tag=centre,scores={random=7}] run tp @a ~250 200 ~-1950 0 0
...
schedule function a:zstart5 200t
